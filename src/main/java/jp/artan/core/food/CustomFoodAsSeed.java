...
public abstract class CustomFoodAsSeed extends ItemFood implements IPlantable, IItemRegisterEvent {
    public CustomPlant plant;
    protected final String name;

    public CustomFoodAsSeed(String name, int amount, float saturation, CustomPlant plant) {
